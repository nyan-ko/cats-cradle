...
class QuestTree:
    ...
    # def print(self) -> None:
    #     """ Prints this tree in the console.
    #     """
    #     self._print_helper(0)

    # def _print_helper(self, depth: int) -> None:
    #     """
    #     """

    #     print(" " * depth + self.current_node.serialize())

    #     for subtree in self.paths:
    #         subtree._print_helper(depth + 1)
